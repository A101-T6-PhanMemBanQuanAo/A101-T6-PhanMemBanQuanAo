...
namespace WebsiteBanHang.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            var lstProducts = objWebsiteBanHangEntities.Products.ToList();
        ...
        public ActionResult Create(Product model)
        {
            ...
            //Lưu
            WebsiteBanHangEntities7 db = new WebsiteBanHangEntities7();
        ...
        {
            var productModel = objWebsiteBanHangEntities.Products.Where(n => n.Id == Id).FirstOrDefault();
        ...
        public ActionResult Edit(Product model)
        {
            ...
            var EditModel = objWebsiteBanHangEntities.Products.Where(n => n.Id == model.Id).FirstOrDefault();
        ...
        {
            var productModel = objWebsiteBanHangEntities.Products.Where(n => n.Id == Id).FirstOrDefault();
            objWebsiteBanHangEntities.Products.Remove(productModel);
